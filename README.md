...
Off Chain Backend: [TypeScript](https://www.typescriptlang.org/) in [Deno RTE](https://deno.land/) - [example](https://github.com/distributed-ledger-technology/airdrop/blob/main/src/airdrop-service.ts#L47)  
